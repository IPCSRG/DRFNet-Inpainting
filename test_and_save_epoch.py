...
# load test data
val_image = './Datasets/piarstreet/paris_eval_gt-256'
...
for suffix_idx in range(6):
    ...
    val_mask = './Datasets/piarstreet/paris_test_irrmask-256/' + val_mask_suffix[suffix_idx]

    save_dir = './results/Psv_DRFNet'+'/'+save_dir_suffix[suffix_idx]
    ...
    for idx in range(len(test_image_flist)):
        ...
        comp_imgs = postprocess(model.merged_images5)
